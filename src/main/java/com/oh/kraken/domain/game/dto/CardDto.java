...
public class CardDto {
    private final String cardId; // ⭐️ [추가] DOM 식별용 ID
    private final boolean isMine; // ⭐️ [추가] 내 카드인지 여부
    private final boolean isRevealed; // ⭐️ [추가] 뒤집혔는지 여부
    // ⭐️ [FIX] 뒤집힌 카드(isRevealed=true)일 때만 카드 타입 전송
    private final CardType cardType;
    private final boolean isKraken;
    private final boolean isTreasure;

    /**
     * ⭐️ [FIX] 생성자가 PlayerCard와 isMine을 받도록 수정
     */
